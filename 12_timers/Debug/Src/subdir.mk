...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DNUCLEO_F411RE -DSTM32 -DSTM32F4 -DSTM32F411RETx -c -I"/home/anthon/Embd/repos/STM32F4-Baremetal_Workspace/chip_headers/CMSIS/Device/ST/STM32F4xx/Include" -I"/home/anthon/Embd/repos/STM32F4-Baremetal_Workspace/chip_headers/CMSIS/Include" -I"/home/anthon/Embd/repos/STM32F4-Baremetal_Workspace/12_timers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
